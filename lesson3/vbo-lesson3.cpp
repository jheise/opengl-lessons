...
void display(){
    ...
    //setup second cube
    //model = glm::translate(glm::mat4(), glm::vec3(-4,0,0));
    ...
    //setup third cube
    //model = glm::translate(glm::mat4(), glm::vec3(4,0,0));
    //model = glm::rotate(model, degree, glm::vec3(0,0,1));
...
void PrepVertexUniforms(){
    ...
    if( umvp == -1){
        throw std::runtime_error(std::string("mpv uniform not found!"));
    }
